...
public class System_Collections_Generic_KeyValuePair_string_objectWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", _CreateSystem_Collections_Generic_KeyValuePair_string_object);
	...
	static int ToString(IntPtr L)
	{
		try
		{
			...
			System.Collections.Generic.KeyValuePair<string,object> obj = (System.Collections.Generic.KeyValuePair<string,object>)ToLua.CheckObject(L, 1, typeof(System.Collections.Generic.KeyValuePair<string,object>));
