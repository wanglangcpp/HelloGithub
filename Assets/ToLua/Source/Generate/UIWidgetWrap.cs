...
public class UIWidgetWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("onUpdateRQ", get_onUpdateRQ, set_onUpdateRQ);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_onUpdateRQ(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIWidget obj = (UIWidget)o;
			UIDrawCall.OnUpdateRqCallback ret = obj.onUpdateRQ;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index onUpdateRQ on a nil value" : e.Message);
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_onUpdateRQ(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIWidget obj = (UIWidget)o;
			UIDrawCall.OnUpdateRqCallback arg0 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (UIDrawCall.OnUpdateRqCallback)ToLua.CheckObject(L, 2, typeof(UIDrawCall.OnUpdateRqCallback));
			}
			else
			{
				LuaFunction func = ToLua.ToLuaFunction(L, 2);
				arg0 = DelegateFactory.CreateDelegate(typeof(UIDrawCall.OnUpdateRqCallback), func) as UIDrawCall.OnUpdateRqCallback;
			}
