...
namespace Genesis.GameClient.Behavior
{
    ...
    public class DestroyUIEffect : Action
    {
        [SerializeField]
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            int count = EffectsController.DestroyEffect(m_EffectKeyParams.Length <= 0 ? m_EffectKeyFormat.Value : string.Format(m_EffectKeyFormat.Value, m_EffectKeyParams));
            return count <= 0 ? TaskStatus.Failure : TaskStatus.Success;
        }
    }
}
