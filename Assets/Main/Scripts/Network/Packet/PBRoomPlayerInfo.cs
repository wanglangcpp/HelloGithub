...
namespace Genesis.GameClient
{
    ...
    public partial class PBRoomPlayerInfo
    {
        ...
        private int? m_InBattleEntity;
        [ProtoMember(5, Name = @"InBattleEntity", IsRequired = false, DataFormat = DataFormat.TwosComplement)]
        public int InBattleEntity
        {
            get { return m_InBattleEntity ?? default(int); }
            set { m_InBattleEntity = value; }
        }
        public bool HasInBattleEntity { get { return m_InBattleEntity != null; } }
        private void ResetInBattleEntity() { m_InBattleEntity = null; }
        private bool ShouldSerializeInBattleEntity() { return HasInBattleEntity; }
    }
}
