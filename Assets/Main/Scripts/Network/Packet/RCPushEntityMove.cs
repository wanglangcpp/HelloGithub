...
// Proto source: 4100_RCPushEntityMove.proto
//----------------------------------------------------------------------------------------------------
...
{
    [Serializable, ProtoContract(Name = @"RCPushEntityMove")]
    public partial class RCPushEntityMove : PacketBase
    {
        public RCPushEntityMove() { }

        public override PacketType PacketType { get { return PacketType.RoomServerToClient; } }

        public override int PacketActionId { get { return 4100; } }
