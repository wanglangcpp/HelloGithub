...
// Proto source: 4101_RCPushEntityPerformSkillStart.proto
//----------------------------------------------------------------------------------------------------
...
{
    [Serializable, ProtoContract(Name = @"RCPushEntityPerformSkillStart")]
    public partial class RCPushEntityPerformSkillStart : PacketBase
    {
        public RCPushEntityPerformSkillStart() { }

        public override PacketType PacketType { get { return PacketType.RoomServerToClient; } }

        public override int PacketActionId { get { return 4101; } }
