...
// Proto source: 4108_RCPushEntityAddBuff.proto
//----------------------------------------------------------------------------------------------------
...
{
    [Serializable, ProtoContract(Name = @"RCPushEntityAddBuff")]
    public partial class RCPushEntityAddBuff : PacketBase
    {
        public RCPushEntityAddBuff() { }

        public override PacketType PacketType { get { return PacketType.RoomServerToClient; } }

        public override int PacketActionId { get { return 4108; } }
        ...
        [ProtoMember(7, Name = @"Buffs", DataFormat = DataFormat.Default)]
