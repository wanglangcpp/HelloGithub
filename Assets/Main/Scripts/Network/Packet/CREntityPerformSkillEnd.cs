...
// Proto source: 5102_CREntityPerformSkillEnd.proto
//----------------------------------------------------------------------------------------------------
...
{
    [Serializable, ProtoContract(Name = @"CREntityPerformSkillEnd")]
    public partial class CREntityPerformSkillEnd : PacketBase
    {
        public CREntityPerformSkillEnd() { }

        public override PacketType PacketType { get { return PacketType.ClientToRoomServer; } }

        public override int PacketActionId { get { return 5102; } }
