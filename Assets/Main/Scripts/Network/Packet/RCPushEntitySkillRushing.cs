...
// Proto source: 4107_RCPushEntitySkillRushing.proto
//----------------------------------------------------------------------------------------------------
...
{
    [Serializable, ProtoContract(Name = @"RCPushEntitySkillRushing")]
    public partial class RCPushEntitySkillRushing : PacketBase
    {
        public RCPushEntitySkillRushing() { }

        public override PacketType PacketType { get { return PacketType.RoomServerToClient; } }

        public override int PacketActionId { get { return 4107; } }
