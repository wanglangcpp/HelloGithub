...
namespace Genesis.GameClient
{
    ...
    public partial class PBRoomHeroInfo
    {
        ...
        [ProtoMember(28, Name = @"MaxSteadyValue", IsRequired = false, DataFormat = DataFormat.FixedSize)]
        public float MaxSteadyValue
        {
            get { return m_MaxSteadyValue ?? default(float); }
            set { m_MaxSteadyValue = value; }
        }
        public bool HasMaxSteadyValue { get { return m_MaxSteadyValue != null; } }
        private void ResetMaxSteadyValue() { m_MaxSteadyValue = null; }
        private bool ShouldSerializeMaxSteadyValue() { return HasMaxSteadyValue; }

        private float? m_SteadyRecoverSpeed;
        [ProtoMember(29, Name = @"SteadyRecoverSpeed", IsRequired = false, DataFormat = DataFormat.FixedSize)]
        public float SteadyRecoverSpeed
        {
            get { return m_SteadyRecoverSpeed ?? default(float); }
            set { m_SteadyRecoverSpeed = value; }
        }
        public bool HasSteadyRecoverSpeed { get { return m_SteadyRecoverSpeed != null; } }
        private void ResetSteadyRecoverSpeed() { m_SteadyRecoverSpeed = null; }
        private bool ShouldSerializeSteadyRecoverSpeed() { return HasSteadyRecoverSpeed; }

        private float? m_SteadyValue;
        [ProtoMember(30, Name = @"SteadyValue", IsRequired = false, DataFormat = DataFormat.FixedSize)]
        ...
        [ProtoMember(31, Name = @"SteadyBarStatus", IsRequired = false, DataFormat = DataFormat.Default)]
        ...
        [ProtoMember(32, Name = @"LastBreakSteadyTime", IsRequired = false, DataFormat = DataFormat.Default)]
        [System.ComponentModel.DefaultValue(null)]
        ...
        private readonly List<PBInt64> m_LastUseSkillTime = new List<PBInt64>();
        [ProtoMember(33, Name = @"LastUseSkillTime", DataFormat = DataFormat.Default)]
        public List<PBInt64> LastUseSkillTime
        {
            get { return m_LastUseSkillTime; }
        }

        private PBInt64 m_LastLeaveBattleTime = null;
        [ProtoMember(34, Name = @"LastLeaveBattleTime", IsRequired = false, DataFormat = DataFormat.Default)]
        [System.ComponentModel.DefaultValue(null)]
        public PBInt64 LastLeaveBattleTime
        {
            get { return m_LastLeaveBattleTime; }
            set { m_LastLeaveBattleTime = value; }
        }

        private bool? m_HasBattled;
        [ProtoMember(35, Name = @"HasBattled", IsRequired = false, DataFormat = DataFormat.Default)]
        public bool HasBattled
        {
            get { return m_HasBattled ?? default(bool); }
            set { m_HasBattled = value; }
        }
        public bool HasHasBattled { get { return m_HasBattled != null; } }
        private void ResetHasBattled() { m_HasBattled = null; }
        private bool ShouldSerializeHasBattled() { return HasHasBattled; }

        private readonly List<PBBuffInfo> m_Buffs = new List<PBBuffInfo>();
        [ProtoMember(36, Name = @"Buffs", DataFormat = DataFormat.Default)]
