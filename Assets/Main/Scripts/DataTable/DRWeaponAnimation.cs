...
namespace Genesis.GameClient
{
    ...
    /// 武器动作表。
    /// </summary>
    public class DRWeaponAnimation : IDataRow
    {
        /// <summary>
        /// 模型编号。
        /// </summary>
        ...
        /// 与展示模型交互的所有动作名称。
        /// </summary>
        public string[] ModelInteractionClipNames
        {
            get
            {
                return new string[] { ModelInteraction1, ModelInteraction2, ModelInteraction3 };
            }
        }
        ...
        {
            new Dictionary<int, DRWeaponAnimation>();
        }
    }
}
