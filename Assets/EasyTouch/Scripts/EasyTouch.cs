...
public class EasyTouch : MonoBehaviour
{
    ...
    private const int MaxTouchCount = 20;
    ...
    private Finger[] fingers = new Finger[MaxTouchCount];                       // The informations of the touch for finger 1.
    ...
    private void UpdateTouches(bool realTouch, int touchCount)
    {
        ...
        Finger[] tmpArray = new Finger[MaxTouchCount];
        ...
        if (realTouch || enableRemote)
        {
            ...
            for (var i = 0; i < touchCount; ++i)
            {
                ...
                int t = 0;
                while (t < MaxTouchCount && fingers[i] == null)
                {
                    if (tmpArray[t] != null)
                    {
    ...
    #endregion One finger Private methods
    ...
    #endregion Two finger private methods
    ...
    private Finger GetFinger(int finderId)
    {
        ...
        while (t < MaxTouchCount && fing == null)
        {
            if (fingers[t] != null)
            {
